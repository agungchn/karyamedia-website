# Setup Task Scheduler untuk generate artikel manual (Senin & Kamis 10:00 WIB)
...
$description = "Generate 1 artikel SEO priority (plakat batas wilayah) - Senin & Kamis 10:00 WIB"

# Check if task already exists
$existingTask = Get-ScheduledTask -TaskName $taskName -ErrorAction SilentlyContinue

if ($existingTask) {
  Write-Host "⚠️  Task '$taskName' sudah ada. Mengupdate..." -ForegroundColor Yellow
...
try {
  ...
  Write-Host "❌ Gagal membuat task: $_" -ForegroundColor Red
  Write-Host ""
